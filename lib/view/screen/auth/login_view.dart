...
import 'package:dilevery_app/core/class/handling_data_veiw.dart';
import 'package:dilevery_app/core/class/status_request.dart';
import 'package:dilevery_app/core/constant/colors.dart';
import 'package:dilevery_app/core/function/alert_exit_app.dart';
...
import 'package:dilevery_app/view/widget/auth/logo_auth.dart';
import 'package:dilevery_app/view/widget/auth/p_auth.dart';
            ...
            child: Form(
              ...
              child: ListView(
                children:  [
                  ...
                  const hSpace(2),
                  InkWell( onTap: (){},child: const Text('Forget Password',textAlign: TextAlign.end,)),
                  const hSpace(2),
                  CustomGeneralButton(text: 'Log In',onPressed: (){controller.login();}),
                  const hSpace(3),
                  TextSignupOrLogin(text1: "Don't have account ? ",text2: "Signup",onTap: (){},),
                ],
              ),
            ),
          ),),
